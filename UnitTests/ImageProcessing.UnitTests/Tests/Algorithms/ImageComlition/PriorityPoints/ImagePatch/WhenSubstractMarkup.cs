...
namespace Tests
{
    ...
    class WhenSubstractMarkup
    {
        ...
        [Test]
        public void ShouldNotFailWhenPatchNotFull()
        {
        ...
        [Test]
        public void ShouldBeComplite2()
        {
            int[][] markupImage = new int[][]
                        {
                          new int[]{000,200,100,000,000},  
                          new int[]{120,090,001,000,000},  
                          new int[]{230,140,140,000,000},  
                          new int[]{010,010,100,000,000},  
                          new int[]{230,100,020,000,000},  
                          new int[]{120,010,000,000,000},  
                        };
