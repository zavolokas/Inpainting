...
{
    public static class Area2DSubstractTests
    {
        public static void RunAll()
        {
            AreaSubstractionTest(TestSet.Init256x128());
            AreaSubstractionTest(TestSet.Init1280x720());
        }

        public static void AreaSubstractionTest(TestSet ts)
        {
            string testName = nameof(AreaSubstractionTest);
            ...
            try
            {
                ...
                areas.Add(Area2D.Create(0, 0, ts.Picture.Width, ts.Picture.Height));
